...
import scannerRunRouter from './api/scanner/router';
import realTimeScannerRouter from './api/real-time-scanner/router';
import backtestRouter from './api/backtest/router';
import stocksRouter from './api/stocks/router';
import smartMoneyRouter from './api/smart-money/router';
...
app.use('/api/scanner', scannerRunRouter);
app.use('/api/real-time-scanner', realTimeScannerRouter);
