...
export const REGISTERED_STRATEGIES: StrategyDefinition[] = [
  {
    ...
    version: '1.1.0',
    status: 'ACTIVE',
    requiredInputs: ['latestPrice', 'sma50', 'sma200', 'rawSignal', 'dataQuality', 'marketGate', 'sectorLeadership', 'sectorRelativeStrengthScore', 'smartMoneyStatus'],
    entryRules: [
  ...
  },
  {
    ...
    version: '1.1.0',
    status: 'ACTIVE',
    requiredInputs: ['latestPrice', 'previousClose', 'sma50', 'sma200', 'rsi', 'dataQuality', 'marketGate'],
    entryRules: [
  ...
  },
  {
    ...
    version: '1.1.0',
    status: 'ACTIVE',
    requiredInputs: ['latestPrice', 'high52Week', 'volume', 'averageVolume20', 'rawSignal', 'marketGate', 'dataQuality', 'bars'],
  ...
  },
  {
    ...
    version: '1.1.0',
    status: 'ACTIVE',
    requiredInputs: ['smartMoneyStatus', 'smartMoneyScore', 'latestPrice', 'sma50', 'averageVolume20', 'dataQuality'],
  ...
  },
  {
    ...
    version: '1.1.0',
    status: 'ACTIVE',
    requiredInputs: ['latestPrice', 'sma50', 'sma200', 'rawSignal', 'sectorLeadership', 'sectorRelativeStrengthScore', 'dataQuality'],
