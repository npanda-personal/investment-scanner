...
export const REGISTERED_STRATEGIES: StrategyDefinition[] = [
  {
    ...
    parameters: { minScore: 80, backtestEntryRule: 'SMA50_ABOVE_SMA200', backtestExitRule: 'PRICE_BELOW_SMA50', maxHoldingDays: 180, trailingStopPercent: 0.12 },
  ...
  },
  {
    ...
    noiseFilters: [rule('OVEREXTENDED', 'Reject when price is too far above SMA50.', 'latestPrice/sma50', 'BLOCKS', 0.08), rule('MARKET_CLOSED', 'Market gate is closed.', 'marketGate', 'BLOCKS', 'CLOSED')],
    ...
    parameters: { minScore: 80, nearSmaPercent: 0.05, maxExtensionPercent: 0.08, backtestEntryRule: 'PRICE_ABOVE_SMA50', backtestExitRule: 'PRICE_BELOW_SMA50', stopLossPercent: 0.08, maxHoldingDays: 90 },
  ...
  },
  {
    ...
    parameters: { minScore: 80, maxExtensionPercent: 0.18, backtestEntryRule: 'SIGNAL_DIRECTION_BULLISH', backtestExitRule: 'PRICE_BELOW_SMA50', stopLossPercent: 0.07, trailingStopPercent: 0.1, maxHoldingDays: 120 },
  ...
  },
  {
    ...
    marketGateRules: [rule('MARKET_NOT_CLOSED', 'Market gate should not be closed.', 'marketGate', 'REQUIRES')],
    parameters: { minScore: 80, backtestEntryRule: 'SIGNAL_DIRECTION_BULLISH', backtestExitRule: 'SIGNAL_DIRECTION_BEARISH', maxHoldingDays: 120, stopLossPercent: 0.1 },
  ...
  },
  {
    ...
    marketGateRules: [rule('MARKET_NOT_CLOSED', 'Market gate should not be closed.', 'marketGate', 'REQUIRES')],
    parameters: { minScore: 80, backtestEntryRule: 'SMA50_ABOVE_SMA200', backtestExitRule: 'PRICE_BELOW_SMA50' },
