...
export const REGISTERED_STRATEGIES: StrategyDefinition[] = [
  ...
  },
  {
    ...
    parameters: { minScore: 70, nearSmaPercent: 0.05, maxExtensionPercent: 0.12, backtestEntryRule: 'PRICE_ABOVE_SMA50', backtestExitRule: 'PRICE_BELOW_SMA50', stopLossPercent: 0.08, maxHoldingDays: 90 },
  ...
  },
  {
    ...
    parameters: { minScore: 72, maxExtensionPercent: 0.18, backtestEntryRule: 'SIGNAL_DIRECTION_BULLISH', backtestExitRule: 'PRICE_BELOW_SMA50', stopLossPercent: 0.07, trailingStopPercent: 0.1, maxHoldingDays: 120 },
  ...
  },
  {
    ...
    marketGateRules: [rule('MARKET_NOT_CLOSED', 'Market gate should not be closed.', 'marketGate', 'REQUIRES')],
    parameters: { minScore: 70, backtestEntryRule: 'SIGNAL_DIRECTION_BULLISH', backtestExitRule: 'SIGNAL_DIRECTION_BEARISH', maxHoldingDays: 120, stopLossPercent: 0.1 },
