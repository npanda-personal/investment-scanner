...
const controller = {
  ...
  marketMap: jest.fn(),
  marketScan52wHigh: jest.fn(),
  marketScan52wLow: jest.fn(),
  marketScanDeliverySpike: jest.fn(),
  marketScanVolumeSpike: jest.fn(),
  screener: jest.fn(),
  ...
  it('registers canonical v1 routes including FX endpoints', () => {
    expect(routePaths(createMarketDataV1Router(controller))).toEqual(
      expect.arrayContaining([
        ...
        'GET /market-data/scans/52w-high',
        'GET /market-data/scans/52w-low',
        'GET /market-data/scans/delivery-spike',
        'GET /market-data/scans/volume-spike',
        'GET /market-data/screener',
