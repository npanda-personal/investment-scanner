...
async function main() {
  ...
  console.log(`[seed-us-fundamentals] processed=${r.processed} updated=${r.updated} annualPeriods=${r.annualPeriods} quarterlyPeriods=${r.quarterlyPeriods} noCik=${r.noCik} noFacts=${r.noFacts}`);
