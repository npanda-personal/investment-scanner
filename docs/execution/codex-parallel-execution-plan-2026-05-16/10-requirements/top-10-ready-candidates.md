...
Current dispatch correction on 2026-05-18: `CF-W1-MD-02A` is in active Team 03 architecture prep, `CF-W1-TP-02` is in active implementation/review follow-up, `CF-W1-SMI-01` is in active Team 06 implementation, `CF-W1-RH-01` is routed to Team 04 QA planning, and `CF-W1-L3-TREV-02` is queued for Team 04 QA planning. After excluding active, queued, accepted, parked, and blocked items, the next top unassigned docs-only requirement is `CF-W1-MD-03`.
...
| --- | --- | --- | --- |
| 1 | `CF-W1-MD-03` | Market Data signoff still does not hard-enforce the active `95%` price-ready / `90%` metadata-ready contract, which is a direct upstream trust gap. | Team 03 bounded signoff-threshold contract prep, then Team 04 QA-plan prep. |
...
Next docs-only handoff after excluding active, queued, accepted, parked, and blocked items: `CF-W1-MD-03` to Team 03 for architecture/contract prep and Team 04 for QA-plan prep.
