...
| CF-W1-DQ-01 | Data Quality fail-closed defaults | Make missing/non-ready DQ safe by default | Data Quality Engine | Lane 1 | P0 | Downstream DQ policy | DQE module files/tests | routes, Prisma, shared utils | Low | Yes | Yes | Yes after approval | policy ambiguity, downstream breakage | missing DQ and non-ready states block trusted use by default | GPT-5.5 high | Blocked by Product Owner + Architect decision |
