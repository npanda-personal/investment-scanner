...
| Fragile mega-pipeline risk | High | Medium | Team 00 + Team 03 + QA | scheduler tries to run market data, DQ, signals, calibration, context, smart money, strategies, backtests, Trade Plan, Research, and Today Review synchronously in one tick | phase stages with idempotent contracts and later durable ledger | keep Slice 1 Market Data only; open schema/route packet before durable orchestration |
