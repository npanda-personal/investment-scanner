...
- Team 00 closed Team 10 and launched Team 06 bounded SPL-02 rework as `019e644a-7cb0-7131-b159-3ba11ccf29c1`.

Active / queued:

- Team 06 `019e644a-7cb0-7131-b159-3ba11ccf29c1`: active on SPL-02 review-reject rework.
...
- Continue monitoring Team 06 SPL-02 rework and Team 08 UX-01B implementation. Route Team 04 QA rerun immediately after the SPL-02 rework handoff.
...
- `CF-W1-RH-01A` was created as a bounded Research Hub actionability evidence-date requirement; it remains not Ready and dependency-gated behind `CF-W2-CAL-02A`.
- `CF-W2-CAL-02A` now has requirement, architecture, contract, work packet, QA plan, exact file reservations, and no open decisions.
- Team 00 promoted `CF-W2-CAL-02A` to Team 06 as the next independent Signal Calibration implementation slice.
- Team 07 completed `CF-W2-TSC-05A` rework and Team 04 QA re-verification is active.
...
- Team 02 completed the rolling direct-value requirement pass; Team 00 corrected stale fresh-candidate references to already accepted `CF-W1-BT-04` and `CF-W1-SMI-01`.
...
- Team 04 QA planning for `CF-W1-DQ-02-RS1` is active as `019e5ec3-2a5b-7840-9d29-65c43a855e19`.
...
- Team 04: complete `CF-W1-DQ-02-RS1` QA plan; then verify `CF-W2-TSC-05A` when Team 07 handoff arrives.
- Team 10: Code Review after Team 04 acceptance.
