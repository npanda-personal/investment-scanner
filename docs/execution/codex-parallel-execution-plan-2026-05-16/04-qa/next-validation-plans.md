...
1. `CF-W1-SIG-01`: signal-generation default/fail-closed DQ tests.
2. `CF-W1-STRAT-01`: no-target-price and exit/invalidation rule wording tests.
3. `CF-W1-MD-01`: Market Data validation hardening tests.
4. `CF-W1-DQ-01`: DQ fail-closed default tests.
