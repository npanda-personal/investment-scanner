...
Latest refresh note: Team 04 added the docs-only QA plan for `CF-W1-BT-02` on 2026-05-18. This records additive backtest review outcomes, registered/custom trade traceability, feature-local review-evidence UI smoke expectations, no-schema/no-route/no-shared-file scope guards, and stop conditions for repository/controller/router/validation/schema/shared-route drift only. It does not approve executable QA, schema work, route work, or simulation-math changes.
...
| `CF-W1-BT-02` | Child QA plan prepared; QA-ready for Team 00 Ready evaluation | Team 03 prepared a bounded no-schema `backtesting-strategy-lab` review-traceability packet; Team 04 aligned trusted/partial/diagnostic-only/legacy-repaired/withheld outcome scenarios, registered/custom trade traceability, feature-local review-evidence UI smoke, and explicit stop conditions against repository/controller/router/validation/schema/shared-route widening to the reserved backend service/types/doc/test plus feature-local types/page/UI spec files. | Team 00 Ready evaluation for the bounded `CF-W1-BT-02` child only, while keeping schema, route, Strategy Framework source, and Trade Plan Risk source widening out of scope. |
...
- `CF-W1-BT-02`: child QA plan is prepared and QA-ready for Team 00 Ready evaluation, but executable validation remains blocked until Team 00 promotes the bounded no-schema `backtesting-strategy-lab` handoff; repository/controller/router/validation/schema/shared-route widening, Strategy Framework source edits, and Trade Plan Risk source edits remain explicit reject conditions.
