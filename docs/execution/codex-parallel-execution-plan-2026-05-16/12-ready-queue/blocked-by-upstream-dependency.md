...
| CF-W1-TP-01 | Trade Plan DQ hard blockers | Strategy Decision target semantics and DQ policy |
| CF-W1-L3-ALERT-01 | Alert readiness consumer tests | Signal Generation trusted-run DQ policy |
| CF-W1-SIG-LATEST-01 | Latest signal auto-generation DQ gate | Signal Generation read-path/trust-classification contract |
