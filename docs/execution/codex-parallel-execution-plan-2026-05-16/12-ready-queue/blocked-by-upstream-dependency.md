...
| CF-W1-TP-01 | Trade Plan DQ hard blockers and no-target migration | Separate Trade Plan target-semantics contract and DQ policy |
| CF-W1-L3-ALERT-01 | Alert readiness consumer tests | Alert readiness consumer contract and strategy/product-language policy; Signal Generation read-path gates are now committed |
